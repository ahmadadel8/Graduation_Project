...
yolo=model(x,nets.MobileNet25, 'voc', yolo_head='sep')
# Define an optimizer
...
checkpoint_path   = "/home/alex054u3/data/nutshell/training_trial_step_mobilenetv1_25_voc-LRShoot_darkconv_more_filters"
