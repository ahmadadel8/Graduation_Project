...
def convbnrelu6(*args, **kwargs):
    ...
    with tf.variable_scope(scope):
        return dropout(relu6(batch_norm(conv2d(*args, **kwargs))),keep_prob=1-dropout_rate)
...
def sconvbnrelu6(*args, **kwargs):
    ...
    dropout_rate=kwargs.pop('dropout_rate', 0)    
    with tf.variable_scope(scope):
        return dropout(relu6(batch_norm(sconv2d(*args, **kwargs))),keep_prob=1-dropout_rate)
